...
export const HeroSectionDesktop = () => {
  ...
  return (
    <section className="w-full min-h-screen flex items-center bg-background">
      <div className="flex w-full px-12 xl:px-20">
        {/* Photo — height driven by the text column via flex stretch */}
        ...
        {/* Text column */}
        <div className="flex-1 flex flex-col justify-center gap-8 pl-14 xl:pl-16 py-24">
          <p className="text-sm font-medium tracking-[0.25em] uppercase text-muted-foreground">
            {t("label")}
          </p>

          <h1 className="text-5xl xl:text-6xl font-bold leading-[1.05] tracking-tight text-foreground">
            Jean–Charles Barq
          </h1>
